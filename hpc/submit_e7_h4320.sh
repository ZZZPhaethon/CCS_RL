...
#SBATCH -o logs/e7_h4320-%A_%a.out
#SBATCH -e logs/e7_h4320-%A_%a.err
...
RESULT_ROOT="$PROJECT_DIR/experiments_results/E7/formal_run06_h4320"
...
if (( model_seed >= 0 )); then
  ...
  final_dir="$RESULT_ROOT/$controller/h4320/model_seed_$model_seed/block_$seed_block"
else
  checkpoint="not_applicable"
  actual_hash="not_applicable"
  final_dir="$RESULT_ROOT/$controller/h4320/block_$seed_block"
fi
...
echo "E7_H4320_TASK_COMPLETE output=$final_dir"
