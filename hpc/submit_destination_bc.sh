#!/usr/bin/env bash
#SBATCH --job-name=ccs_destination_bc
...
#SBATCH -o logs/destination_bc-%A_%a.out
#SBATCH -e logs/destination_bc-%A_%a.err
...
PROJECT_DIR="${PROJECT_DIR:-/scratch_root/hx721/CCS_RLLLM_destination_bc}"
cd "$PROJECT_DIR"
...
VARIANTS=(tcn_mode tcn_mode_destination)
...
OUT_DIR="${OUT_DIR:-output/rl_forecast/destination_bc_formal}"
