...
- 原始 192 动作高层 PPO：`src/sim/control/event_based/rl`；
- 第一版 residual PPO：`src/sim/control/event_based/residual_rl`。
...
```powershell
python -m sim.control.event_based.residual_rl_v2.validate_interventions `
  --seeds 1 4 `
...
```powershell
python -m sim.control.event_based.residual_rl_v2.train_masked_residual_ppo `
  --scenario northern_lights_phase1_3vessels `
  --episode-hours 720 `
  --forecast-context-hours 168 `
  --decision-interval-h 24 `
...
```powershell
python -m sim.control.event_based.residual_rl_v2.train_curriculum_masked_residual_ppo `
  --scenario northern_lights_phase1_3vessels `
  --episode-hours 720 `
  --forecast-context-hours 168 `
  --decision-interval-h 24 `
...
```powershell
python -m sim.control.event_based.residual_rl_v2.evaluate_masked_residual_ppo `
